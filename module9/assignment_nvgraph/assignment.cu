...
int main(int argc, char **argv) {
    const size_t  n = 15, nnz = 10, vertex_numsets = 1, edge_numsets = 1;
    float *sssp_1_h;
    void** vertex_dim;
    // nvgraph variables
    ...
    for ( int i = 0; i < n; i++ )
        std::cout << "Vertex: " << i << " Weight: " << sssp_1_h[i] << "\n";
    std::cout << "Processing took: " << get_duration_ns(start_time, stop_time) << "ns\n";
